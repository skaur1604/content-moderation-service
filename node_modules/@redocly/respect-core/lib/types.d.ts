...
import type { parameter, operationMethod, sourceDescriptionSchema, infoObject, requestBody, replacement, criteriaObject, step, workflow, reusableObject, onSuccessObject, onFailureObject, extendedOperation, extendedSecurity } from './arazzo-schema.js';
...
import type { Config, CollectFn, RuleSeverity, LoggerInterface, BaseResolver } from '@redocly/openapi-core';
...
export type ExecutedStepsCount = {
    value: number;
};
export {};
